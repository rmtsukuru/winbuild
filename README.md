...
2. Run `powershell wget https://raw.githubusercontent.com/rmtsukuru/winbuild/refs/heads/main/winbuild.cmd -OutFile winbuild.cmd` (or run `fetchbuilt.cmd` if you already have it downloaded). This will download winbuild.cmd for you from this repo.
