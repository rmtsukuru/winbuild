:: Let's build a windows dev environment~

:: Install Git for Windows (including Git Bash)
winget install --id Git.Git -e --source winget

:: TODO Add remaining commands for installing mingw-w64, downloading dotfiles, etc.
...
:: Don't forget to clean up random remaining files at the end
